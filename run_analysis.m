function run_analysis (config, inputfile, outputfile, varargin)

% RUN_ANALYSIS Generate updated signals 
%
%   run_analysis (configfile|config, inputfile, outputfile, varargin)
%
% where 
...
%   run_analysis (configfile, inputfile, outputfile)
%
...
sweep_protocol = easy_sweep_protocol ("./DATA/BROOKS/TEST/TESTOKN1_OD1/protocol.json");
