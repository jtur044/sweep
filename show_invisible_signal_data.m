function [data, events] = show_invisible_signal_data  (filename, which_sweep,  varargin) % configfile, dataTbl, tracker_name, varargin)

% SHOW_INVISIBLE_SIGNAL_DATA Show data from eyetracker/results.csvtracker result matrix
%
%   show_invisible_signal_data  (filename, tracker_name, varargin)
%
% where 
...
if (~isempty(res.timeline))
%    k0 = show_events (timeline);
     show_logmar_ticks (res.timeline, which_sweep);
end
