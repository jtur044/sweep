...
for k = 1:K
    ...
    figure (1); clf;
    paired_sweep_visualizer (overall.pair_id(k), outTbl);
...
function paired_sweep_visualizer (pair_id, thisTbl) % , eye_code, VAinfo, which_VA)
...
show_invisible_sweep_data  (sigfile, short_name, timeline, dirn, "showTimePoint", t); 
...
[y0, t0] = show_invisible_sweep_data  (sigfile, short_name, timeline, dirn, "showTimePoint", t, "Color", [ 0 0 0 0.4 ]); 
