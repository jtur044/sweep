function batch_sweep_invisible_processor (main_dir, which_profile, varargin)

% BATCH_SWEEP_INVISIBLE_PROCESSOR Batch analysis of webcam FILES 
%
%   batch_sweep_invisible_processor (main_dir, which_fn, varargin)
%
% where 
%
