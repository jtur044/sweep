function [y0, t0] = show_pupilcore_sweep_data  (filename, which_sweep,  timeline, dirn, varargin) % configfile, dataTbl, tracker_name, varargin)

% SHOW_PUPILCORE_SWEEP_DATA Show data from eyetracker/results.csvtracker result matrix
%
...
%
%  figure (1); clf;
%  show_pupilcore_sweep_data  ('./DATA/BROOKS.PROCESSED/kj_4_18_23/result/eyetracker/results.updated.csv', 'eye_pupil_tracker_os'); 
%
%  figure (2); clf;
%  show_pupilcore_sweep_data  ('./DATA/BROOKS.PROCESSED/kj_4_18_23/result/eyetracker/results.updated.csv', 'eye_pupil_tracker_od'); 
